...
p_uncal_AE <- by_sensor_data |>
  ...
  facet_wrap(~source) +
  labs(
    title = "ARMIE vs Reference PM2.5 Concentrations",
    subtitle = "Uncalibrated values from the ARMIE sensor-node",
...
p_cal_AE <- by_sensor_data |>
  ...
  facet_wrap(~source) +
  labs(
    title = "ARMIE PM2.5 vs Reference PM2.5 Concentrations",
...
p_uncal_RE <- by_sensor_data |>
  ...
  facet_wrap(~source) +
  labs(
    title = "Relative error of ARMIE vs Reference PM2.5",
    subtitle = "Uncalibrated values from the ARMIE sensor-node",
    x = "Reference PM2.5 (µg/m³)",
    y = "Relative error (%)",
    color = "Comparison"
...
BA_plot_uncal <- bland_altman_data |>
  ...
  labs(
    ...
    x = "Reference PM2.5 (µg/m³)",
    y = "ARMIE PM2.5 − Reference PM2.5 (µg/m³)"
  ) +
  theme_minimal()
...
bland_altman_plot_spec_loa_uncal <- bland_altman_data_spec_loa %>%
  ...
  labs(
    #   title = "Bland–Altman Plot of ARMIE vs Reference PM2.5 Concentrations",
    #   subtitle = "Calibrated ARMIE measurements (Leave one sensor out)",
    x = "Reference PM2.5 (µg/m³)",
    y = "ARMIE PM2.5 − Reference PM2.5 (µg/m³)"
  ) +
  theme_minimal() +
