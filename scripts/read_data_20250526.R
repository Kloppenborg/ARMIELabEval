...
date <- "20250526"
start_time <- "08.30"
end_time <- "16.00" #The cloud server ved information from the SPS30 sensors had technical problem between 12 and 22*
chamber_RH <- 70
chamber_temp <- 20
source <- "candles_high_RH"  #Specify the source used to generate particles
aps_seperator <- ";"
